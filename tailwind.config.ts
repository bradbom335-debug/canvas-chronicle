    ...
    extend: {
      colors: {
        ...
        canvas: {
          ...
          "selection-glow": "hsl(var(--canvas-selection-glow))",
        },
        // Panel colors
        panel: {
          bg: "hsl(var(--panel-bg))",
      ...
      boxShadow: {
        ...
        panel: "0 8px 32px hsl(0 0% 0% / 0.3), 0 2px 8px hsl(0 0% 0% / 0.2)",
        inset: "inset 0 2px 4px hsl(0 0% 0% / 0.2)",
      },
      backdropBlur: {
        xs: "2px",
      },
